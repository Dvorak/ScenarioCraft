...
from scenariocraft.core.repair.providers.types import RepairProposal, RepairRequest
from scenariocraft.core.schemas import PatchSpec, PatchSpecError
...
class OpenAIRepairProvider:
    ...
    def _request_payload(request: RepairRequest) -> dict[str, object]:
        ...
        return {
            ...
            "failed_check_results": [result.to_dict() for result in request.failed_check_results],
